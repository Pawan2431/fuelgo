            ...
            {authModalView === 'login' && (
              ...
              >
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center space-x-3 py-2.5 px-4 bg-white hover:bg-gray-50 border border-gray-300 rounded-xl text-sm font-medium text-gray-700 transition-all shadow-sm group"
                >
