...
export const FuelOrderWizard: React.FC = () => {
  ...
  const [paymentMethod, setPaymentMethod] = useState<'upi' | 'credit_line' | 'wallet' | 'card' | 'cod'>('credit_line');
            ...
            {step === 2 && (
              ...
              >
                ...
                <div className="space-y-3 pt-3 border-t border-gray-100">
                  ...
                  {isAddingAddress && (
                    <form onSubmit={handleSaveNewAddress} className="p-4 bg-gray-50 border border-gray-200 rounded-2xl space-y-3">
                      <h5 className="text-xs font-bold text-gray-900">Add Delivery Site</h5>
                      <div className="grid grid-cols-2 gap-2">
                        <input
                          type="text"
                          placeholder="Site Label (e.g. Hub 4 - Whitefield)"
                          value={newAddrLabel}
                        ...
                        <input
                          type="text"
                          placeholder="Pincode (e.g. 560066)"
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 bg-white border border-gray-300 rounded-xl text-xs text-gray-900 placeholder-gray-400 outline-none focus:border-amber-500"
                      />
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {[
                    {
                      id: 'credit_line',
                      name: 'Corporate Credit Line (Net 30)',
                      desc: `Available Limit: ₹${(user?.creditLimit || 500000).toLocaleString('en-IN')}`,
                    ...
                    {
                      id: 'cod',
                      name: 'POS Card / Cheque on Site',
                      desc: 'Handheld POS Terminal with Driver',
                ...
                <div className="flex justify-between pt-4 border-t border-gray-100">
                  ...
                  <button
                    ...
                    className="px-8 py-3.5 bg-gradient-to-r from-amber-500 via-amber-400 to-amber-500 hover:from-amber-400 hover:to-amber-300 text-gray-950 font-extrabold rounded-xl text-sm shadow-md shadow-amber-500/30 flex items-center space-x-2 transition-all transform hover:scale-[1.01]"
                  >
                    <Truck className="w-4 h-4" />
                    <span>Confirm Order & Dispatch Bowser</span>
                  </button>
                </div>
              </motion.div>
            )}
