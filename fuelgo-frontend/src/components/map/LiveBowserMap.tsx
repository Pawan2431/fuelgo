    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <div className="bg-white border border-gray-200 p-3.5 rounded-2xl shadow-xs flex items-center space-x-3">
          ...
          <div>
            <div className="text-[11px] font-medium text-gray-500">Amount to Pay</div>
            <div className="flex flex-col">
              ...
              <span className="text-[10px] font-semibold text-gray-500">
                {activeOrder.paymentMethod === 'cod' ? 'Cash on Delivery' : 'Wallet'} • {activeOrder.paymentStatus === 'paid' ? <span className="text-emerald-600">Paid</span> : <span className="text-amber-600">Pending</span>}
              </span>
            </div>
          </div>
        </div>
