              ...
              >
                ...
                <div className="grid grid-cols-3 gap-1 p-1 bg-gray-100 border border-gray-200 rounded-xl">
                  <button
                    ...
                    className={`py-2 px-1.5 sm:px-3 rounded-lg text-[10px] sm:text-xs font-semibold flex items-center justify-center space-x-1 sm:space-x-2 transition-all ${
                      role === 'b2b_fleet'
                  ...
                  >
                    ...
                    <span className="hidden sm:inline">Fleet Enterprise</span>
                    <span className="sm:hidden">Fleet</span>
                  </button>
                  <button
                    type="button"
                    onClick={() => setRole('b2c_individual')}
                    className={`py-2 px-1.5 sm:px-3 rounded-lg text-[10px] sm:text-xs font-semibold flex items-center justify-center space-x-1 sm:space-x-2 transition-all ${
                      role === 'b2c_individual'
                        ? 'bg-white text-gray-900 shadow-sm border border-gray-200'
                        : 'text-gray-600 hover:text-gray-900'
                  ...
                  >
                    ...
                    <span className="hidden sm:inline">Bowser Driver</span>
